    ...
    return (
        <div className='promotion'>
            ...
            <div className='flex justify-center items-center p-5 bg-[#000] bg-opacity-50 mt-3 grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3'>
                ...
                <div className='mr-3'>
                    <h2 className='uppercase font-bold text-3xl text-transparent text-[#FD8987]'>Slot of the week</h2>
                    <h2 className='mb-3 font-bold text-3xl text-transparent text-[#FD8987]'>$100 slot bonus</h2>
