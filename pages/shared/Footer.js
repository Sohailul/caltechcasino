...
const Footer = () => {
  return (
    <div className="flex justify-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-5 bg-[#000] bg-opacity-100 p-12" style={{backgroundImage: "url(/assets/game-img/footer-bg.png)", backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
      <div className="flex items-end">
        <Image 
        src={prodpoker} 
        alt="" />
      </div>
      <div className="w-80 mr-24 mt-3 mb-12 text-white">
      ...
      <div className="lg:ml-40 w-60 mb-12 text-white lg:mt-24">
