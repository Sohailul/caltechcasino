...
const Footer = () => {
  return (
    <footer>
      <div
        className="bg-[#000] bg-opacity-100 pt-5"
        style={{
          backgroundImage: "url(/assets/game-img/footer-bg.png)",
      ...
      >
        <div className="flex justify-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 px-12">
          ...
          <div className="w-80 mr-24 mt-3 lg:-ml-16 mb-12 text-white">
            ...
            <p className="mb-5">
              Royal Casino is the place where the player join for an awespme
              casino experience,
            </p>
          ...
          <div className="lg:ml-44 w-52 mb-12 text-white lg:mt-24">
            ...
            <p className="mb-5">
              Acess Royal Casino basically everywhere you go
            </p>
            <Link href="#">
            ...
            <br />
            <button
              className="btn btn-ghost border-none rounded-full text-white uppercase px-12 py-3 text-xs signup my-5"
              style={{
                background:
          ...
          <div className="flex items-end flex-col lg:flex-row-reverse">
            <div className="flex justify-center items-center ">
              <Image src={casinoright} alt="" />
            </div>
            <div className="text-justify text-white lg:-ml-96 mb-12">
              <p className="text-[12px] tracking-tight">
                © 2022 Royal Casino Limited or affiliate companies. The
                trademarks are owned by the Royal Casino group of companies and
                used under liense. All rights reserved
              </p>
            </div>
          </div>
        </div>
