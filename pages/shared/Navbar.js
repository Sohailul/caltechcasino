      ...
      <div>
        <div className="navbar" style={{ color: "#fff" }}>
            ...
            <div className="form-control hidden lg:flex">
              ...
              <div className="relative search-input">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block p-3 pl-10 w-80 text-sm text-white border-slate-300 rounded-full bg-[#2F1745]"
          ...
          <div className="navbar-end">
            ...
            <label
              htmlFor="login-modal"
              className="btn modal-button text-white rounded-full uppercase px-8 py-1 login mr-5"
            >
              Login
            </label>
            <label
              htmlFor="signup-modal"
              className="btn modal-button border-none rounded-full text-white uppercase px-8 py-1 signup"
            >
              Sign Up
            </label>
          </div>
