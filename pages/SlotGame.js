...
const SlotGame = () => {
    ...
    return (
        <div>
            <h1 className="text-xs p-2 text-left font-bold grid bg-accent"><span className="w-60 p-2 text-white text-xl border-l-2 border-l-primary" style={{ background: "linear-gradient(90deg, #460F7B 1.68%, rgba(228, 10, 180, 0) 73.74%)" }}>Top slot game</span></h1>
